...
const Header = ({type}) => {
  ...
  // for selecting children and adult 
  ...
  // Onlick Function to handle increatement and decrement
    ...
    <div className='header'>
        ...
        <h1 className="headerTitle">
          ...
          <p className="headerDesc">
            Get rewarded for travels - unlock instant savings of 18% or with a free Free Booking account
          </p>
